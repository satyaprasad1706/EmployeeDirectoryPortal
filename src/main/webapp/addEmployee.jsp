...
<head>
    ...
    <title>Add Employee - Employee Directory Portal</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="main-wrapper">
        ...
        <div class="top-bar">
            <div>
                ...
                <p class="text-muted small mb-0">Add a new record to the employee registry.</p>
            </div>
        ...
        <div class="form-card">
            ...
            <p class="form-subtitle">Enter the employee's basic details and organizational placement.</p>
            ...
            <form action="${pageContext.request.contextPath}/addEmployee" method="POST">
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control form-control-custom w-100" id="firstName" name="firstName" placeholder="Jane" required>
                    </div>
                    
                    <!-- Last Name -->
                    <div class="col-12 col-md-6">
                        <label for="lastName" class="form-label form-label-custom">Last Name</label>
                        <input type="text" class="form-control form-control-custom w-100" id="lastName" name="lastName" placeholder="Doe" required>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="email" class="form-control form-control-custom w-100" id="email" name="email" placeholder="jane.doe@company.com" required>
                </div>
                ...
                <div class="row g-4 mb-5">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control form-control-custom w-100" id="phone" name="phone" placeholder="e.g. +1 555-0199">
                    </div>
                    
                    <!-- Salary -->
                    <div class="col-12 col-md-6">
                        <label for="salary" class="form-label form-label-custom">Salary</label>
                        <input type="number" step="0.01" class="form-control form-control-custom w-100" id="salary" name="salary" placeholder="e.g. 75000">
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end gap-3 pt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-primary-custom px-4 py-2">Save Employee</button>
                </div>
            </form>
        </div>
    </div>
